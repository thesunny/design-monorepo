...
export function FavoritesDrawer({
  ...
  return (
    <div
      className={`fixed top-0 right-0 h-full w-[480px] bg-white shadow-xl z-50 flex flex-col transition-transform duration-200 ease-out ${
        isOpen ? "translate-x-0" : "translate-x-full"
      }`}
    >
      {/* Header */}
      <div className="flex items-center justify-between border-b border-neutral-200 px-8 h-12 flex-shrink-0">
