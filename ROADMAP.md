...
- [x] Category-based font browsing (25 subcategories)
- [x] Three preview modes (Headings, Paragraphs, Code)
- [x] Weight, size, tracking, line height controls
- [x] Italic toggle
- [x] Custom preview text with presets
- [x] Favorites with Convex backend storage
- [x] Bold/Italic/Variable filters
- [x] Font loading with FontFaceObserver
- [x] Normalized text sizing for visual consistency
- [x] Google Fonts metadata integration
